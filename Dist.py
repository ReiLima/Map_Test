...
while(total_distance > 0 and count < 1600):
    ...
    if(is_loop == 1):        
        ...
        if direct == "cima":
            while black_line (start_x - lefter_black,start_y, alcance, 3) == 1 and start_y - lefter_black - 10 > 0:
                lefter_black = lefter_black + 1
                if start_x - lefter_black - 30 < 0:
                    break

            while black_line (start_x + righter_black,start_y, alcance, 3) == 1 and start_y + righter_black + 10 < 400:
